...
// @updateURL     https://plemsy.pl/wp-content/niezbednik/scripts/sumowanie_przybywajacego_wsparcia.meta.js
// @downloadURL   https://plemsy.pl/wp-content/niezbednik/scripts/sumowanie_przybywajacego_wsparcia.user.js
// @version       1.1.8
// @grant         none
// ==/UserScript==
...
(function() {
	...
	function get_commands_ids(timestamp, get_own_commands_ids, get_ally_commands_ids) {
		...
		$(commands_selector).each(function() {
            ...
            var t1 = string_to_timestamp(span.closest('td').next('td').text())
